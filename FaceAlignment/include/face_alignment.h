...
class FaceAlignment{
  ...
  */
  ...
  /** The face pose estimator. This part implement Supervised Descent Method Apply to Face Alignment, and Head Pose Estimation with Linear Regression(SDM).
  * @param gray_im A grayscale image
  * @param[out] face_info The face yaw
  * @param points The locations of detected facial points
  */
  SEETA_API bool FacePoseEstimate(const ImageData& gray_im, FacialLandmark* points, FaceInfo& face_info);
